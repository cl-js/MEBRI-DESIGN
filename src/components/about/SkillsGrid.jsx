...
const skills = [
  ...
  { category: "Traditional Textiles", tools: ["Handwoven Cotton (Shemma)", "Tibeb Borders", "Gabi & Netela", "Hand Embroidery", "Natural Dyeing"] },
  { category: "Design & Atelier", tools: ["Fashion Design", "Bridal Couture", "Traditional Wear", "Runway Collections", "Styling & Modelling"] },
