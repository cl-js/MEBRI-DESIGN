        ...
        <div>
          ...
          <Select value={formData.projectType} onValueChange={(v) => handleChange("projectType", v)}>
            ...
            <SelectContent>
              ...
              <SelectItem value="traditional" className="focus:bg-charcoal focus:text-gallery">Traditional Wear (Habesha)</SelectItem>
              <SelectItem value="bridal" className="focus:bg-charcoal focus:text-gallery">Bridal Couture</SelectItem>
              <SelectItem value="runway" className="focus:bg-charcoal focus:text-gallery">Runway / Editorial</SelectItem>
              <SelectItem value="alterations" className="focus:bg-charcoal focus:text-gallery">Alterations & Tailoring</SelectItem>
